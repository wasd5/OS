...
Is the following statement correct about your submission (please replace
    ...
    We run /sbin/init from the kernel init process in our submission": (Comments?)
...
(B.7) /usr/bin/fork-and-wait (? out of 5 pts)
...
(D.1) /usr/bin/vfstest (5 out of 6 pts)
(D.2) /usr/bin/memtest (5 out of 6 pts)
(D.3) /usr/bin/eatmem (6 out of 6 pts)
(D.4) /usr/bin/forkbomb (6 out of 6 pts)
(D.5) /usr/bin/stress (6 out of 6 pts)

(E.1) /usr/bin/vfstest (0.5 out of 1 pt)
...
Xiangchen Zhao : zhao115@usc.edu
Xiaoyue Gao: xiaoyueg@usc.edu
Wenrui Xu: wenruix@usc.edu
